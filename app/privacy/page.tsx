...
export const metadata: Metadata = {
  ...
  description: "SLIC Media's Privacy Policy - Learn how we collect, use, and protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              <div className="space-y-8 text-muted-foreground leading-relaxed">
                <section>
                  ...
                  <p>
                    At SLIC Media, we collect information you provide directly to us, such as when you fill out a contact form, 
                    schedule a consultation, or communicate with us via email. This may include your name, email address, 
                ...
                <section>
                  ...
                  <p>
                    ...
                    except as necessary to provide our services, comply with the law, or protect our rights. We may share 
                    information with trusted third-party service providers who assist us in operating our website and conducting 
                    our business.
                  </p>
                </section>
                ...
                <section>
                  <h2 className="font-display text-2xl font-semibold text-foreground mb-4">6. Cookies</h2>
                  <p>
                    Our website uses cookies to enhance your browsing experience. You can set your browser to refuse all or 
                    some cookies, or to alert you when cookies are being sent. If you disable cookies, some parts of our 
                    website may not function properly.
                  </p>
                </section>

                <section>
                  <h2 className="font-display text-2xl font-semibold text-foreground mb-4">7. Contact Us</h2>
                  <p>
